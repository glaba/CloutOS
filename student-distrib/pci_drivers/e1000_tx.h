...
#define ETH_TRANSMIT_DESCRIPTOR_BASE_ADDR_L 0x3800 // TDBAL
#define ETH_TRANSMIT_DESCRIPTOR_BASE_ADDR_H 0x3804 // TDBAH
#define ETH_TRANSMIT_DESCRIPTOR_BUF_LEN     0x3808 // TDLEN
#define ETH_TRANSMIT_DESCRIPTOR_HEAD        0x3810 // TDH 
#define ETH_TRANSMIT_DESCRIPTOR_TAIL        0x3818 // TDV 
#define ETH_TRANSMIT_IPG                    0x0410 // TIPG
#define ETH_TRANSMIT_CONTROL                0x0400 // TCTL 
...
#define DESCRIPTOR_BUFFER_ALIGNMENT 16
// The size of the tx_descriptor and rx_descriptor buffers
#define DESCRIPTOR_BUFFER_SIZE 128
